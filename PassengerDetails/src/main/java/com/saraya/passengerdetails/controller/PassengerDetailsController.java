...
public class PassengerDetailsController {
	...
	@GetMapping("/{telephone}/{email}")
	public PassengerDetailsDTo getPassengerByTelepAndMail(@PathVariable String telephone, @PathVariable String email) {
		return detailsServices.FinByTelephoneAndEmail(telephone, email);
	}
}
